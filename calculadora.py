...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Herbety')
        ...
        self.add_btn(
            ...
            'background: #d5580d; color: #fff; font-weight: 700; text-decoration: underline white;'
        )
        ...
        self.add_btn(
                QPushButton('c2'), 3, 4, 1, 1,
                lambda: self.display.setText(
                    self.display.text()[:-2]
                ),
                'background: #ccaa34; color: #fff; font-weight: 700;'    
            )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,
            'background: #2f79ae; color: #fff; font-weight: 700;'
            )
